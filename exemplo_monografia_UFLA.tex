...
\usepackage{setspace}			 % necessário para usar essa versao do abntex e hyperref
...
\resumo{%
Se encontrar correções necessárias, por favor informar!\\
Contato:\\
\url{https://github.com/joaopaulo7/Template-Trabalhos-Academicos-UFLA} (preferêncial)\\
joao.lima10@estudante.ufla.br}  % Resumo (digite aqui o resumo)
