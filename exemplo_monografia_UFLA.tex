...
\lstset{
   ...
   inputencoding=utf8,
   literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ú}{{\'u}}1
...
%==============================================================================
% criação do glossário, índice, listas de siglas, símbolos e etc
\input{glossarios/abreviaturas}
\input{glossarios/glossario}
\input{glossarios/indice}
\input{glossarios/siglas}
\input{glossarios/simbolos}
%==============================================================================
...
\edicao{6$^a$(?) edição atualizada e ampliada, mas não muito revista}
\date{2025}
...
> Suporte para mais de 26 anexos/apêndices;\\
...
\include{secoes/elementos}
\include{secoes/conclusao}
\include{secoes/listasGlossarioIndice}
