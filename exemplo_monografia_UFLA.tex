...
\input{glossários/acronimos}
\input{glossários/glossario}
\input{glossários/indice}
\input{glossários/siglas}
\input{glossários/simbolos}
...
%==============================================================================
% incluindo as seções
\include{seções/introducao}
\include{seções/elementos}
\include{seções/conclusao}
