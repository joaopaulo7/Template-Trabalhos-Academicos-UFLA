...
\includegraphics[scale=0.9]{imgs/gradpenguin}\\  % o 0.9 indica 90% do tamanho original
...
\vspace{-12pt} % O verbatim tem um espaçamentoi estranho. Isso corrige.
...
\lstinputlisting{codigos/Hello.java}
{\small Fonte: fonte da figura} %Fonte da imagem
\end{figure}
...
\begin{table}[h!]
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \centering {\small Fonte: fonte da tabela} %Fonte do tabela
\end{table}
...
\begin{center}
  ...
  \end{tabular}
\end{center}
\centering {\small Fonte: fonte do quadro} %Fonte da quadro
\end{quadro}
